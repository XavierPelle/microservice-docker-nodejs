...
export class CartComponent implements OnInit {
  ...
  constructor(private authService: AuthentificationService, private requestBuilderService: RequestBuilderService, private router: Router) {}
  ...
  buy(): void {
    ...
    this.router.navigate(['/payment'], { state: { amount: total } });
  }
}
