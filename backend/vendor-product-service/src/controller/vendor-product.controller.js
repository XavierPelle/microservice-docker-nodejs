...
const getAll = async (req, res) => {
  ...
  const getProductById = async (req, res) => {
    try {
      ...
      const product = await VendorProduct.findByPk(id);
...
const updateProduct = async (req, res) => {
  try {
      const id = req.params.id;
      await VendorProduct.update(req.body, { where: { id: id } });
  ...
  const deleteProduct = async (req, res) => {
    ...
    try {
        ...
        await VendorProduct.destroy({ where: { id: id } });
...
const createFakeProduct = async (req, res) => {
  try { 
    ...
    for (const product of productsData) {
      await VendorProduct.create(product);
    }
